...
select
	id_empresa, nome, setor, num_funcionarios
from
	resultados;
...
select
	id_empresa as "Empresas",
    nome as "Nome_Empresas",
    setor as "Setor_Empresas",
    receitas as "Receita_Empresas"
from resultados;
...
select
	*
from resultados
	where setor = 'Tecnologia' -- 43 Empresas no setor de Tecnologia
	where setor = 'Energia' -- 57 Empresas no setor de Energia
